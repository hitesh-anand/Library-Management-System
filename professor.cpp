...
public:
    ...
    Professor(string name, int id, string password, string userName)
    {
        this->name = name;
        this->id = id;
    ...
    void issue_book(Book *b)
    {
        ...
        else
        {
            ...
            num_issued_books++;
            cout << "The book has been successfully issued to your name. Kindly return the book before 60 days to avoid any fine amount." << endl;
        }
    }
